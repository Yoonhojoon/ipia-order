...
class MemberServiceImplTest {
    ...
    void signup_Success_ValidEmailFormats() {
        // given
        String[] validEmails = {
                "test@example.com",
        ...
        verify(memberRepository, times(validEmails.length)).save(any(Member.class));
    }

    @Test
    @DisplayName("이름이 정확히 100자인 경우 가입 성공")
    void signup_Success_NameExactly100Characters() {
        // given
    ...
    void signup_Success_EmailExactly200Characters() {
        // given
        String name = "홍길동";
        String email = "a".repeat(188) + "@example.com"; // 정확히 200자
